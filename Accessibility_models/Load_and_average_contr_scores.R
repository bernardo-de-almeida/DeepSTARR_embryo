...
# run
# Load_and_average_contr_scores.R CNS_log2 Results_fold03_CNS_DeepSTARR2/Model Sequences_CNS_peaks_1kb.fa Results_fold03_CNS_DeepSTARR2/Sequences_all_peaks_1kb.fa_predictions_Model.txt
